...
import '../students/helper/student_duplicate_helper.dart';
...
class _AdminPanelState extends ConsumerState<AdminPanel> {
      ...
      builder: (context, _) {
        ...
        if (isTouched) {
          ...
          if (lowerLabel.contains("employee id") || lowerLabel.contains("teacher id")) {
            if (trimmed.isEmpty) {
              errorText = "Employee ID cannot be empty";
              isValid = false;
            } else {
              ...
              if (isDuplicate) {
                errorText = "Employee ID already exists!";
                isValid = false;
              }
            }
          } else if (isEmail) {
  ...
  /// 🔹 Validated Field Widget with real-time validation & error showing
